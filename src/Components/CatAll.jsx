...
//   console.log(data);
  const CatAll = data.filter((item)=> item.catogory == "cat-food" || item.catogory == "cat-treat")
    ...
    <div  className='text-center py-5 h-max md:mt-32 mt-64'>
      ...
      <div className='flex justify-center mb-8'>
        <hr style={{border: '1px solid rgba(5, 37, 96, 0.3)'}} className=' w-4/5'/>
            ...
            <h1 style={{color:'#052560'}} className='font-serif text-3xl font-bold'>All Items For Dogs</h1>
