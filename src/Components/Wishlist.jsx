...
const Wishlist = () => {
  ...
  return (
    <div className='mx-auto mb-24 p-5 px-20 justify-center md:flex-row gap-5 md:mt-28 mt-72'>
        
        <h2 style={{color:'#052560'}} className="text-2xl font-bold mb-4 text-center">Wishlist</h2>

        {wishlist.length === 0 ? (
            <div className='flex flex-col items-center text-center bg-gray-100 p-10 rounded-lg space-y-3'>
                <RiDislikeFill className='h-14 w-14'/>
                <p style={{color:'#052560'}} className='font-semibold text-xl'>No Liked Products</p>
            </div>
        ):(null)}

        <div className='flex gap-4 flex-wrap justify-center mt-7 p-16 bg-gray-100'>
            {wishlist.map((item)=>{
                return(
